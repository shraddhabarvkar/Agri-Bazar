            ...
            <div class="register-form mt-5 px-4">
              <form action="" onsubmit="return validation()" method="POST">
                <div class="form-group text-left mb-4"><span>Mobile Number</span>
                  ...
                  <input class="form-control" name="mobile" id="mobileNumber" type="number" autocomplete="off" placeholder="Mobile Number">
				  <span id="mobileno" class="text-danger font-weight-bold"> </span>
                </div>
                <div class="form-group text-left mb-4"><span>Password</span>
                  <label for="password"><i class="lni lni-lock"></i></label>
                  <input class="form-control" name="password" id="pass" type="password" placeholder="********************">
