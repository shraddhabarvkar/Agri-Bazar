...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if($task=="contact"){
		$subject="Contact / feedback Received From Website amplewish.com.";
		...
		$subject="Call Back Request Received From Website amplewish.com.";
		$body="<b>Online Call Back Request Received From: </b> <br/> Mobile: <b>".$mob." </b><br/>Thank You.";
	}
	else if($task=="newslatter"){
		$subject="News Letter Request Received From Website amplewish.com.";
		...
		else
        {
          ...
          if ($conn->query($sql) === TRUE) {
			$message="Hi, ".$name."! Your Franchise request is Received and under Review Process on amplewish.com. Your User Name: ".$mob." and password:".$pass." Thank You.";
			$mobile_number=$mob;
			$message1= sms_unicode($message);
			sentsms($message1, $mobile_number);
			//SMS to Admin
			$message="New Franchise Request is Received from ".$name." on amplewish.com. User Name: ".$mob." and password:".$pass." Thank You.";
		...
		$subject="Franchise Application Received from amplewish.com.";
    ...
    $mail->addReplyTo('amplewish@gmail.com', 'Ample Wish');
    $mail->addAddress($adminemail, 'Ample Wish');
