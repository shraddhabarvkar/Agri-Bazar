...
if (isset($_POST['sendotp']))
{
	...
	{ 
		...
		$message="Hi, Use OTP Code ".$_SESSION['otp_code']." For amplewish.com Registration. Thank You!";
	...
	{ 
		...
		if($_SESSION['otp_code']==$otp){
			$euid=$_SESSION['last_id'];
					...
					$message="Hi, ".$euname."! Your Account is Successfully created on amplewish.com. Your User Name: ".$myusername." and password:".$mypassword." Thank You.";
					$mobile_number=$myusername;
					$message1= sms_unicode($message);
					sentsms($message1, $mobile_number);
					//SMS to Admin
					$message="New Account created by ".$euname." on amplewish.com. User Name: ".$myusername." and password:".$mypassword." Thank You.";
					$mobile_number="9657020022";
					$message1= sms_unicode($message);
					sentsms($message1, $mobile_number);
					//Email Code
					$subject="Welcome ".$euname." to amplewish.com.";
					$body="Hi <b>".$euname."</b>, <br/> Your Registration completed successfully to amplewish.com <br/>	Your Username:<b>  ".$myusername." </b><br/> Password: <b>".$mypassword." </b><br/>Email: <b>".$email." </b><br/>Thank You.";
					$mail = new PHPMailer;
					$mail->isSMTP();
					$mail->SMTPDebug = 1;
