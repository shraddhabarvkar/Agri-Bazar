	...
	{ 
		...
		if($result->num_rows>0){
			...
			if ($result->num_rows > 0){
				...
				$sql = "INSERT INTO end_user ( euname, eumob, eupass, email, bdate, address, euregdate, status)
				VALUES ('$euname', '$myusername','$mypassword','$email','$bdate','$address', '$today', 1)";
            ...
            <div class="register-form mt-5 px-4">
              <form action="" method="POST">
				...
				<div class="form-group text-left mb-4"><span>Email Id</span>
                  <label for="password"><i class="lni lni-envelope"></i></label>
